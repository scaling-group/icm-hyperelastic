...
uv run python src/train.py logger=[csv,wandb] data=multiBC_ultimix_valid_train_scaling_plane_stress task_name="train_scaling"\
    model=pre-endecoder-A-0.15M \
    trainer.max_steps=1740000 trainer.val_check_interval=174000
